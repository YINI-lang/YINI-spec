...
- **Support for modern needs** — Structured sections, clear value types, multiline strings, inline comments, and formal grammar. (Though, there is a a date/time object — which is not yet addressed in YINI, maybe in future when YINI is more mature.)
...
[4] Lines in YINI can be temporarily disabled without removing them (technically same function as to "commenting out").
