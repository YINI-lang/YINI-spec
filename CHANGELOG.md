...
- **Removed:** In the specification and in the ANTLR4 grammar, removed Hyper Strings (H-Strings). While useful for readable long-form text, they served a narrow use case and overlapped with existing string forms. Their removal keeps the core language smaller, clearer, and more predictable.
